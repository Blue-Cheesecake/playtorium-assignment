...
class _$ProductDtoImpl implements _ProductDto {
  _$ProductDtoImpl({required this.id, required this.quantity});
  ...
  @override
  String toString() {
    return 'ProductDto(id: $id, quantity: $quantity)';
  }
...
abstract class _ProductDto implements ProductDto {
  factory _ProductDto({required final int id, required final int quantity}) =
      _$ProductDtoImpl;
